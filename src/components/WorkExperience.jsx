    ...
    <main className="">
      ...
      <div className="mx-auto max-w-3xl flex flex-col md:flex-row gap-10">
        <div className="flex md:flex-col md:gap-4 group dark:scrollbar-track-zinc-900 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300 dark:scrollbar-thumb-zinc-800 overflow-x-auto md:overflow-clip max-w-xl text-sm md:text-base ">  
          <button className={` dark:hover:bg-zinc-700 hover:bg-gray-100 px-4 py-2 text-zinc-400 md:min-w-28 md:w-full rounded-md flex flex-row justify-center md:justify-start space-x-2 items-center  ${workIndex === 0 ? "dark:bg-zinc-700 bg-zinc-100" : "bg-inherit"}`} onClick={() =>ChangeWorkIndex(0)}>
          ...
          <button className={` dark:hover:bg-zinc-700 hover:bg-gray-100 px-4 py-2 text-zinc-400 md:min-w-28 md:w-full rounded-md flex flex-row justify-center md:justify-start space-x-2 items-center  ${workIndex === 1 ? "dark:bg-zinc-700 bg-zinc-100" : "bg-inherit"}`} onClick={() =>ChangeWorkIndex(1)}>
          ...
          <button className={`dark:hover:bg-zinc-700 hover:bg-gray-100 px-4 py-2 text-zinc-400  md:min-w-28 md:w-full rounded-md flex flex-row justify-center md:justify-start space-x-2 items-center  ${workIndex === 2 ? "dark:bg-zinc-700 bg-zinc-100" : "bg-inherit"}`} onClick={() =>ChangeWorkIndex(2)}>
          ...
          <button className={`dark:hover:bg-zinc-700 hover:bg-gray-100 px-4 py-2 text-zinc-400  md:min-w-28 md:w-full rounded-md flex flex-row justify-center md:justify-start space-x-2 items-center ${workIndex === 3 ? "dark:bg-zinc-700 bg-zinc-100" : "bg-inherit"}`} onClick={() => ChangeWorkIndex(3)}>
            <div className="flex gap-2 items-center ">
                <div className="dark:bg-zinc-800  rounded-full p-1">
          ...
          <button className={`dark:hover:bg-zinc-700 hover:bg-gray-100 px-4 py-2 text-zinc-400  md:min-w-28 md:w-full rounded-md flex flex-row justify-center md:justify-start space-x-2 items-center ${workIndex === 4 ? "dark:bg-zinc-700 bg-zinc-100" : "bg-inherit"}`} onClick={() => ChangeWorkIndex(4)}>
          <div className="flex gap-2 items-center ">
