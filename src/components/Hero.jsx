  ...
  return (
    <main >
      ...
      <div className="tracking-tight text-lg" >
        ...
        <p className=" text-zinc-700 dark:text-zinc-400 mb-5">Building <span className="dark:text-zinc-50 font-bold px-2 py-1 bg-gray-100 dark:bg-zinc-700">Aceternity</span> , <span className="dark:text-zinc-50 font-bold px-2 py-1 bg-gray-100 dark:bg-zinc-700" >Rogue</span> other <span className="dark:text-zinc-50 font-bold">cool things</span></p>
        <p className=" dark:text-zinc-500 text-zinc-600 leading-normal">Senior Software Engineer building SaaS products and web apps. Find me on <span className="dark:text-zinc-400 text-zinc-700 font-bold">twitter</span> for tech updates and memes.</p>
