  ...
  return (
    <main >
      ...
      <div className="tracking-tight text-lg" >
        ...
        <p className=" dark:text-zinc-500 text-zinc-600 leading-normal">Full-stack developer focused on building modern web apps and impactful SaaS solutions. Catch me on <a href="https://x.com/YuvrajBal4" target="_blank"><span className="dark:text-zinc-400 text-zinc-700 font-bold">twitter</span></a> for tech updates and memes.</p>
        
      </div>
      <div>
        <img src="grad_pic-cyan.png" className="w-48 h-auto rounded-md ml-4" alt="" />
      </div>
